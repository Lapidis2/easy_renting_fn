...
const SupplyDetail = () => {
  ...
  return (
    <MainLayout>
      <div className="container mx-auto p-6 mt-2 bg-white rounded shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6">
          <span className="bg-green-100 hover:bg-green-200 transition text-green-800 text-sm font-semibold px-4 py-1 rounded-md uppercase">
            {property.status}
          </span>
