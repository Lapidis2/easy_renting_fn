...
const getAssetPropertyByType = () => {
  ...
  const Noassets = <div className="text-center py-20 text-lg">No assets available for this type.</div>;
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mt-[100px] mb-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        { 
        !assets? Noassets : assets.map((item) => (
          <div
            key={item._id}
